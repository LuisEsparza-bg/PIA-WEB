...
<body class="Background">
  ...
  <nav class="navbar fixed-top navbar-expand-lg NavbarStyle"> 
        ...
        <button class="ButtonNavBar navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
        ...
        <div class="collapse navbar-collapse " id="navbarSupportedContent">
          <ul class="navbar-nav mr-auto">
            <li class="nav-item active">
              <a class="CurrentPage NavbarText nav-link" href="../JSP/home.jsp">Home <span class="sr-only"></span></a>
            </li>
      ...
      <div>
        <h2 class="SearchedTabTitle" > POST RECIENTES</h2> 
        <br>
     </div>
     ...
     <div class="container">
       ...
       <div>
         <nav aria-label="Page navigation example" class="PageCenterBottom" style="margin-top: 0.2rem;">
           <ul class="pagination">
