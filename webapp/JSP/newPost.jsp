	    ...
	    <div class="AdvancedSearchBox col-md-8 col-md-offset-2">
    		...
    		<form>
              ...
              <select class="AdvancedSearchBoxTextBox">
                  <option>Select a tag for the post</option>
                ...
                <ul class="list-group" style="margin-top: 1rem;">
                  <li class="AdvancedSearchBoxTagsContainer list-group-item active">Added Tags:</li>
    		    ...
    		    <div class="form-group" style="margin-top: 1rem; text-align: center;">
    		        <button type="submit" class="ButtonColor btn">
    		            Create
    		        </button>
    		        <button class="btn btn-danger">
    		            Cancel
